...
using ImageIO;
using UIKit;
//http://motzcod.es/post/68297751685/animated-gif-uiimageview-in-xamarinios
    ...
    public class AnimatedImageView
    {
        ...
        private static UIImageView CreateAnimatedImageView(CGImageSource imageSource, UIImageView imageView = null)
        {
            ...
            for (var i = 0; i < frameCount; i++)
            {
                ...
                var properties = imageSource.GetProperties(i);
            ...
            var imageSourceProperties = imageSource.GetProperties();
            ...
            {
                KeyPath = "contents",
                RepeatCount = imageSourceLoopCount <= 0.0f ? float.MaxValue : imageSourceLoopCount
            };
